...
/**
 * Returns overdue amount (sum of all overdue invoices) for the scorecard widget
 */
class OverdueScorecardProvider implements ScorecardInterface
{
    ...
    {
        return 'sales-documents-overdue';
    }

    public function getLabel(): string
    {
        return 'acme.salesdocument.dashboard.scorecard.overdue.label';
    }
    ...
    public function getData(): ?string
    {
        ...
        $qb->select('SUM(doc.amount - COALESCE(doc.amountPaid, 0)) as total')
           ...
           ->andWhere('doc.dueDate < CURRENT_DATE()')
